...
type ProductionMaterialSummaryReportFiltersProps = {
  from: string
  to: string
...
export function ProductionMaterialSummaryReportFilters({
  from,
  to,
  onFromChange,
  onToChange,
  ...
  onDownload,
  theme,
}: ProductionMaterialSummaryReportFiltersProps) {
  return (
    <ReportFiltersPanel
      subtitle="Período, cliente y exportación del resumen de material producido"
      loading={loading}
