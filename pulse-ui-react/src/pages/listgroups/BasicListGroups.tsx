                        ...
                        <ul className="divide-y">
                            ...
                            <li className="flex gap-4 p-4">
                                <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl border bg-muted/50">
                                    <img
                                        src="/axones/images/cards/eComm/01.png"
                            ...
                            <li className="flex gap-4 p-4">
                                <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl border bg-muted/30">
                                    <img
                                        src="/axones/images/cards/eComm/02.png"
                                        alt="Smartwatch Pro"
                                        className="h-12 w-12 object-contain"
                                    />
                                </div>
                            ...
                            <li className="flex gap-4 p-4">
                                <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl border bg-muted/30">
                                    <img
                                        src="/axones/images/cards/eComm/03.png"
                            ...
                            <li className="flex gap-4 p-4">
                                <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl border bg-muted/30">
                                    <img
                                        src="/axones/images/cards/eComm/04.png"
                                        alt="iPhone 16"
                                        className="h-12 w-12 object-contain"
                                    />
                                </div>
                            ...
                            <li className="flex gap-4 p-4 rounded-b-2xl">
                                <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl border bg-muted/30">
                                    <img
                                        src="/axones/images/cards/eComm/05.png"
                                        alt="DSLR Camera"
                                        className="h-12 w-12 object-contain"
                                    />
                                </div>
